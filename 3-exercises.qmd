...
Use bootstrap resampling to estimate the bias of the maximum likelihood estimator of the variance;$$s^2=\frac1n \sum_{i}(x_i-\bar x)^2,$$ for the dataset:

$$X = \{4.2, 3.9, 5.1, 4.8, 4.3, 5.0, 3.7, 4.5, 4.9, 4.6\}.$$
Describe the procedure and discuss the sign of the bias.
...
$$\widehat \theta = \frac{-1}{n}\sum_{i=1}^n \log x_i.$$
</details>
