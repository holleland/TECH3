...
a) With $n=40$ observations, we can approximate the probability using the central limit theorem (CLT). That is $\bar X_{40}\sim N(0.18, 0.06/\sqrt{40})$: 
$$P(16\%\le \bar X_{40}\le 19\%)=P(\bar X_{40}\le 19\%)-P(\bar X_{40}\le 16\%)=0.8366$$
...
such that the density of the X's is 
$$f(x,\mu,\sigma)=\frac{1}{\sqrt{2\pi\sigma^2}} \exp \left( -\frac{(x - \mu)^2}{2\sigma^2}.$$
