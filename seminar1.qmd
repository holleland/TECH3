...
a)  For the given set of data, find the
...
b) What is the probability that X is larger than 2?

c) Show that the distribution of X fulfills the memoryless property, i.e. that 
$$P(X>s+t|X>s)=P(X>t).$$ 
